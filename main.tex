...
\begin{itemize}
    ...
    \end{itemize}
    \item Dependencies: Utilizes read.asd and extract.metadata from the FieldSpectra package for reading and extracting data. \\ SummarizedExperiment library from Bioconductor.
\end{itemize}
