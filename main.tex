...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{imagimages/ml.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{imagesimages/PLSR.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{images/se_asd_1.png}
