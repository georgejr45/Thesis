...
Function} \texttt{read\_summarizedexperiment\_asd(path)}: \\ 
\hspace*{2em}Input: Path to a single \texttt{.asd} file or a directory containing multiple \texttt{.asd} files. \\  
\hspace*{2em} Output: A \texttt{SummarizedExperiment} object  
