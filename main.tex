...
\begin{titlepage}
    ...
    \begin{flushright}
        \centering
        \includegraphics[width=2cm]{Figures/thd.png} % Adjust width as needed
        \hspace{0cm} % Space between images
        \includegraphics[width=2cm]{Figures/ipb.jpg} % Adjust width as needed
    \end{flushright}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/NIRS_spectra.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/ml.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/PLSR.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/rf.png}
...
\subsubsection{Mathematical Explanation of Random Forest Regression}
...
\textbf{Trait} & \textbf{$R^2$} & \textbf{RMSE} & \textbf{Training time} \\
\midrule
SLA  & 0.89 & 0 & 28.11 min \\
LDMC & 0.88 & 0 & 30.20 min \\
C:N  & 0.74 & 0 & 4.11 min \\
C    & 0.36 & 0 & 4.83 min \\
P    & 0.20 & 0 & 31.30 sec \\
\bottomrule
