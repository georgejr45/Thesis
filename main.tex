...
The massive amounts of data collected through this techniqes presents both opportunities and challenges to scientific communities. The vast amount of data collected require efficient processing to generate useful results in limited time frame and this is where Machine Learning (ML) becomes indispensable.
ML algorithams can analyse complex, high-dimentional datasets, enabling accurate predictions of plant traits or other features based on the input data on study [4][5]. 
