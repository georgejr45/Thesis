...
1. The core R system, which can be downloaded from CRAN for different platforms like Linux, Windows and MacOS \\
2. Additional functionality through various packages \\
